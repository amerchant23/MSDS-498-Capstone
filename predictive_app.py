# -*- coding: utf-8 -*-
"""predictive_app.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1RdzrtYNr7oQRYigS9cLsoo35DoI-gw3B
"""

!pip install scikit-learn==1.6.1 pandas==2.2.2 numpy==2.0.2 joblib==1.5.0 --quiet
...
joblib.dump((pipeline_rf, X_train.columns.tolist()), "pipeline_rf_protocol4.pkl", protocol=4)
...
def predict_adoption_speed(pet_info: dict, description: str, pipeline: Pipeline, training_columns: list) -> tuple:
    ...
    print(input_df)
    print("Input DataFrame columns after alignment:", input_df.columns.tolist())
...
# Replace 'pipeline_rf_protocol4.pkl' with the actual filename if different
files.download('pipeline_rf_protocol4.pkl')