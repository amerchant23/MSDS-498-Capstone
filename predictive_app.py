...
print(f"scikit-learn version (after install): {sklearn.__version__}")
print(f"pandas version (after install): {pd.__version__}")
print(f"joblib version (after install): {joblib.__version__}")
...
# Save model and training columns
joblib.dump((pipeline_rf, X_train.columns.tolist()), "pipeline_rf.pkl", protocol=3) # Or try protocol=3
...
# Save model and training columns
joblib.dump((pipeline_rf, X_train.columns.tolist()), "pipeline_rf.pkl", protocol=4)
pipeline_rf, saved_columns = joblib.load("pipeline_rf.pkl")

print("Model saved and loaded with scikit-learn version:", sklearn.__version__)
