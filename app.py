...
print(f"Python version (deployed): {sys.version}")
print(f"Scikit-learn version (deployed): {sklearn.__version__}")
print(f"pandas version (deployed): {pd.__version__}")
print(f"joblib version (deployed): {joblib.__version__}")
print(f"numpy version (deployed): {np.__version__}")
...
# --- Configuration ---
MODEL_URL = "https://drive.google.com/file/d/1hHzyJNEB2nGbsCSOEcxm4IwVlkrpeoxY/view?usp=sharing"
    ...
    if st.button("Predict Adoption Speed"):
        if not description.strip():
            ...
            pet_info = {
                ...
                "MainBreed": main_breed or "",  # Change np.nan to ""
